...
export default function PrincipleCard({
  ...
  return (
    <Link
      ...
      className="group flex min-h-[220px] cursor-pointer items-center justify-center rounded-2xl border border-surface-border bg-[linear-gradient(180deg,#ffffff_0%,#f7fbfc_100%)] p-8 text-center shadow-[0_10px_30px_rgba(15,23,42,0.05)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#67e8f9] hover:bg-accent-subtle hover:shadow-[0_16px_36px_rgba(8,145,178,0.12)] focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface-page"
    >
